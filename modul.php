...
class Modul{
    ...
    public function ban($str,$status,$ver){
        ...
        echo str_pad(str_repeat(" ",round($l/5)).$this->col("[ ","c").$this->col("ｓｔａｔｕｓ: ","k").$this->col($status,"h")." | ".$this->col("ｖｅｒｓｉ: ","k").$this->col($ver,"h").$this->col(" ]","c"),$l,str_repeat(" ",$l),STR_PAD_BOTH).PHP_EOL;
        echo $this->strip("u");
